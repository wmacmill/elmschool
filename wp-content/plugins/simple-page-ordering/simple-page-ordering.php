<?php
/*
Plugin Name: Simple Page Ordering **check before updating**
Plugin URI: http://10up.com/plugins/simple-page-ordering-wordpress/
Description: Order your pages and hierarchical post types using drag and drop on the built in page list. For further instructions, open the "Help" tab on the Pages screen. **Before updating read updating.txt file**
Version: 2.2.4
...
class Simple_Page_Ordering {
	...
	private static function check_edit_others_caps( $post_type ) {
		...
		$edit_others_cap = empty( $post_type_object ) ? 'edit_' . $post_type : $post_type_object->cap->edit_posts; //this is the custom line
