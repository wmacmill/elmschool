<?php
/*
Plugin Name: Resend Welcome Email *check before updating*
Plugin URI: http://www.twitter.com/atwellpub
Description: Adds option to regenerate and resend password to user. Adds this option to user profile edit screen. **check line 32 for cusomization**
Version: 1.0.2
Author: adbox
Author URI: http://www.twitter.com/atwellpub
*
*/
if ( ! defined( 'ABSPATH' ) ) exit; //custom
	...
	class Resend_Welcome_Email {
		...
		*/
		public function __construct() {
			...
			if (!current_user_can('group_leader')) { //custom user_can
				return;
			}
		...
		*/
		...
		public static function personal_options(  WP_User $user ) {
			...
			<tr>
				...
				<td><a class="reset-password-field" href="<?php echo $link; ?>"><?php _e( 'Reset Password and Send Welcome Email', 'user-switching' ); ?></a></td>
			</tr>
			<?php
		}
