...
tr:hover .wpProQuiz_actions {
	...
	<div class="wrap wpProQuiz_statisticsNew">
		...
		<div style="padding: 10px 0px;" class="wpProQuiz_tab_wrapper">
			<a class="button-primary" href="#" data-tab="#wpProQuiz_tabHistory"><?php _e('History', 'wp-pro-quiz'); ?></a>
			<a class="button-secondary" href="#" data-tab="#wpProQuiz_tabOverview"><?php _e('Overview', 'wp-pro-quiz'); ?></a>
		</div>
				...
				<div class="postbox">
					...
					<div class="inside">
						<ul>
								...
								<label>
									...
									<select id="wpProQuiz_historyUser">
										<optgroup label="<?php _e('special filter', 'wp-pro-quiz'); ?>">
											<option value="-1" selected="selected"><?php _e('all users', 'wp-pro-quiz'); ?></option>
											<option value="-2"><?php _e('only registered users', 'wp-pro-quiz'); ?></option>
											<option value="-3"><?php _e('only anonymous users', 'wp-pro-quiz'); ?></option>
										</optgroup>
							...
							<li>
								<input type="button" value="<?php _e('Filter', 'wp-pro-quiz'); ?>" class="button-secondary" id="filter">
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="postbox">
					...
					<div class="inside">
						<ul>
							...
							<li>
								<input type="button" value="<?php _e('Filter', 'wp-pro-quiz'); ?>" class="button-secondary" id="overviewFilter">
							</li>
						</ul>
					</div>
				</div>
