...
jQuery(document).ready(function($) {
    ...
    var imagePath = location.pathname.replace(/wp-admin.*/, 'wp-content/plugins/sfwd-lms/images/');
    ...
    $.setupQuizForm = function(element, options) {
        ...
        plugin.formListener = {
            ...
            setup: function() {
                ...
                $("#submitpost").delegate('#publish', "click", function(e){
...
*/
                ...
                var saveUrl  = location.replace('post.php', 'admin-ajax.php');
