...
$wpbi_settings['parameter']['ch-x-label']	= 'ch_x_label';
...
$wpbi_settings['parameter']['ch-y-label'] 		= 'ch_y_label';
...
$wpbi_settings['parameter']['charts_help'] 		= '<div id="help_barchart"><p><span style="font-weight:bold">Bar Chart</span></p><p>Each column marked as "value" will be plotted as a column.<br/>The "label" will be on the x axis.<br/>Set the color to "#ffffff" (white) to generate random bars colors.</p><p><a href="http://www.wpbusinessintelligence.com/wp-business-intelligence-faq" target="_blank">See the FAQ</a> for more details.</p></div>
