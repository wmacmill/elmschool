...
function init_help() {
    ...
    switch (selected_chart) {
        case '{CH_NEW_TYPE_BAR}':
            ...
            break;
        case '{CH_NEW_TYPE_BAR_HORIZONTAL}':
            jQuery("#help_linechart").hide();
            jQuery("#help_cumulinechart").hide();
        ...
        case '{CH_NEW_TYPE_LINE}':
            ...
            jQuery('#yCurrencyLabel').hide();
            break;
        case '{CH_NEW_TYPE_PIE}':
        case '{CH_NEW_TYPE_DONUT}':
            jQuery("#help_linechart").hide();
            jQuery("#help_cumulinechart").hide();
            jQuery("#help_hbarchart").hide();
            jQuery("#help_multibarchart").hide();
        ...
        case '{CH_NEW_TYPE_SCATTER}':
            ...
            jQuery('#yCurrencyLabel').hide();
            break;
        case '{CH_NEW_TYPE_CUMULATIVE_LINE}':
            jQuery("#help_linechart").hide();
        ...
        case '{CH_NEW_TYPE_STACKED_AREA}':
            ...
            jQuery('#yCurrencyLabel').hide();
            break;
        case '{CH_NEW_TYPE_MULTI_LINE_FOCUS}':
            jQuery("#help_linechart").hide();
            jQuery("#help_cumulinechart").hide();
            jQuery("#help_hbarchart").hide();
            jQuery("#help_multibarchart").hide();
...
<form method="post" id="new_chart_2" name="new_chart_2" action="{CH_NEW_FORM_ACTION}">
	<table class="widefat">
      <tr>
        <td align="left" valign="top"><table class="widefat">
    	<thead>
        	<tr bgcolor="#CCCCCC" valign="top">
              <td colspan="2" align="left" scope="row"><strong>{CH_NEW_BASIC_SETTINGS}</strong></td>
            </tr>
        </thead>
		<tbody>
        	<tr valign="top">
				<td width="199" align="right" scope="row"><div align="left">{CH_NEW_NAME}</div></td>
			  <td width="286" align="left" valign="top"><input name="{P_CH_NAME}" type="text" id="{P_CH_NAME}" value="{V_CH_NAME}" maxlength="64"></td>
	        </tr>
            <tr valign="top">
				<td width="199" align="right" scope="row"><div align="left">{CH_NEW_TITLE}</div></td>
			  <td align="left" valign="top"><input name="{P_CH_TITLE}" type="text" id="{P_CH_TITLE}" value="{V_CH_TITLE}" maxlength="64"></td>
	        </tr>
			<tr valign="top">
				<td width="199" align="right" scope="row"><div align="left">{CH_NEW_TYPE}</div></td>
		  <td align="left" valign="top">
            ...
            <tr valign="top">
				<td width="199" align="right" scope="row"><div align="left">{CH_NEW_HEIGHT}</div></td>
            ...
            <tr valign="top">
                <td width="30" align="right" scope="row"><div id="xPrecisionLabel" align="left">{CH_NEW_X_PRECISION}</div></td>
                <td align="left" valign="top">
                    <input style="width:30px;" name="{P_CH_X_PRECISION}" type="text" id="{P_CH_X_PRECISION}" value="{V_CH_X_PRECISION}" maxlength="11">
                </td>
            </tr>
            <tr valign="top">
                <td width="30" align="right" scope="row"><div id="yPrecisionLabel" align="left">{CH_NEW_Y_PRECISION}</div></td>
                <td align="left" valign="top">
                    <input style="width:30px;" name="{P_CH_Y_PRECISION}" type="text" id="{P_CH_Y_PRECISION}" value="{V_CH_Y_PRECISION}" maxlength="11">

            </tr>
            <tr valign="top">
                <td width="120" align="right" scope="row"><div id="yRangeLabel"  align="left">{CH_NEW_Y_RANGE}</div></td>
                <td align="left" valign="top">
                    <input style="width:120px;" name="{P_CH_Y_RANGE}" type="text" id="{P_CH_Y_RANGE}" value="{V_CH_Y_RANGE}" maxlength="32">
            </tr>
            <tr valign="top">
                <td width="120" align="right" scope="row"><div id="xLabelLabel"  align="left">{CH_NEW_X_LABEL}</div></td>
                <td align="left" valign="top">
                    <input style="width:120px;" name="{P_CH_X_LABEL}" type="text" id="{P_CH_X_LABEL}" value="{V_CH_X_LABEL}" maxlength="32">
            </tr>
            <tr valign="top">
                <td width="120" align="right" scope="row"><div id="yLabelLabel"  align="left">{CH_NEW_Y_LABEL}</div></td>
                <td align="left" valign="top">
                    <input style="width:120px;" name="{P_CH_Y_LABEL}" type="text" id="{P_CH_Y_LABEL}" value="{V_CH_Y_LABEL}" maxlength="32">
            </tr>
            <tr valign="top">
                <td width="199" align="right" scope="row"><div id="timeFormatLabel" align="left">{CH_NEW_TIME_FORMAT}</div></td>
                <td align="left" valign="top">
                    <input style="width:180px;" name="{P_CH_TIME_FORMAT}" type="text" id="{P_CH_TIME_FORMAT}" value="{V_CH_TIME_FORMAT}" maxlength="32">

            </tr>
            <tr valign="top">
                <td width="30" align="right" scope="row"><div align="left">{CH_NEW_SNAPSHOT}</div></td>
                <td align="left" valign="top">
                    <input type="checkbox" name="{P_CH_SNAPSHOT}" value="1" {V_CH_SNAPSHOT_CHECKED}></td>
            </tr>
            <tr valign="top">
                <td width="30" align="right" scope="row"><div id="stackedLabel" align="left">{CH_NEW_STACKED}</div></td>
                <td align="left" valign="top">
                    <input type="checkbox" id="{P_CH_STACKED}" name="{P_CH_STACKED}" value="1" {V_CH_STACKED_CHECKED}></td>
            </tr>
            <tr valign="top">
                <td width="30" align="right" scope="row"><div id="yCurrencyLabel" align="left">{CH_NEW_Y_CURRENCY}</div></td>
                <td align="left" valign="top">
        ...
        <td align="left" valign="top" width="550px"><table class="widefat">
          <thead>
            <tr bgcolor="#CCCCCC" valign="top">
              <td align="left" scope="row"><strong>{CH_NEW_COLUMNS}</strong></td>
              <td align="left" valign="top"><strong>{CH_NEW_COL_LABEL}</strong></td>
              <td align="left" valign="top"><strong>{CH_NEW_COL_VALUE}</strong></td>
              <td align="left" valign="top"><strong>{CH_NEW_COL_COLOR}</strong></td>
              <td align="left" valign="top"><strong>{CH_NEW_COL_RENAME}</strong></td>
              <td align="left" valign="top"><strong>{CH_NEW_COL_ISTIME}</strong></td>
            </tr>
          </thead>
          <tbody>
              {CH_NEW_COLUMNS_OPTIONS}
          </tbody>
        </table></td>
      </tr>
    </table>
...
<p class="submit">
    ...
    <div>
        <div id="savebutton" style="float: left;"><input type="submit" class="button-primary" value="{LBL_BTN_ADD}" onmousedown="jQuery('input[name={P_CH_ACTION}]').attr('value', '{V_ADD_ACTION}')"></div>
