...
class wpbi_AesCtr extends wpbi_aes {
    ...
    public static function encrypt($plaintext, $password, $nBits) {
        ...
        $key = wpbi_aes::cipher($pwBytes, wpbi_aes::keyExpansion($pwBytes));
        ...
        $keySchedule = wpbi_aes::keyExpansion($key);
        //print_r($keySchedule);
        ...
        for ($b=0; $b<$blockCount; $b++) {
            ...
            $cipherCntr = wpbi_aes::cipher($counterBlock, $keySchedule);  // -- encrypt counter block --
