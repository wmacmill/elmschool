...
class nvd3_placeholder
{
    ...
    public function render()
    {
        ...
        {
            $url = site_url();
            $html = '<div id="camera"><img id="camera" title="download picture" src="' . $url . '/wp-content/plugins/wp-business-intelligence-lite/images/camera.png" onclick="chartPicture(\'' .substr($this->name, 3). '\')"></div>';
            $html .= '<div id="camera"><img id="camera" title="download PDF" src="' . $url . '/wp-content/plugins/wp-business-intelligence-lite/images/pdf.jpg" onclick="chartPdf(\'' .substr($this->name, 3). '\')"></div>';
        }
